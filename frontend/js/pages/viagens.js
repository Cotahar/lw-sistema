    ...
    colunas: [
      ...
      { chave: 'motorista_nome', titulo: 'Motorista' },
      {
        ...
        render: (r) => {
          ...
          return `
            <details>
              <summary class="inline cursor-pointer text-brand-600 hover:underline">${r.localizacao_cidade}/${r.localizacao_uf}</summary>
              <div class="mt-1 text-xs text-slate-500">
                Atualizado em ${formatarDataHoraBr(r.localizacao_atualizado_em)}<br />
                <a href="https://www.google.com/maps/search/?api=1&query=${consulta}" target="_blank" rel="noopener" class="text-brand-600 hover:underline">Abrir no Google Maps</a>
              </div>
            </details>
          `;
        },
